        ...
        <div class="w-full flex flex-col justify-start items-start py-4">
          <div class="w-full gap-x-12 flex justify-start items-center relative">
            ...
            <div class="w-[40%]">
              ...
              >
                <InputField v-model="form.email" :max-length="75" class="!pl-3"></InputField>
                <template #help>
                  <div class="text-transparent"></div>
                </template>
                <!-- <a-input v-model="form.post" placeholder="please enter your post..." /> -->
          ...
          <div class="w-full gap-x-12 flex justify-start items-center relative mt-4">
            ...
            <div class="w-[40%]">
              ...
              >
                ...
                >
                  <a-option :value="item.key" v-for="(item, index) in rolesList()" :key="index">
                    <p class="uppercase">{{ item.value }}</p>
                  </a-option>
                </a-select>
              </a-form-item>
            </div>
...
const rolesList = () => [
  ...
  {
    key: 'student',
    value: EnumUserRole.STUDENT
  },
  {
    key: 'instructor',
    value: EnumUserRole.INSTRUCTOR
  }
]
...
const onSubmit = async () => {
  ...
  await userTempStore.onCreateUser(form.name, form.email, form.role as EnumUserRole)
  router.back()

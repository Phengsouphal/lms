...

    {
      ...
      children: [
        ...
        },
        {
          path: '/' + RouteName.TERM,
          name: RouteName.TERM,
          component: () => import('../views/pages/administrator/term.vue'),
          meta: { requiresAuth: true, keepAlive: true }
        },
        {
          path: '/' + RouteName.ATTENDANCE,
          name: RouteName.ATTENDANCE,
          component: () => import('../views/pages/administrator/attendance.vue'),
          meta: { requiresAuth: true, keepAlive: true }
        },
        {
          path: '/' + RouteName.ENROLLMENT,
          name: RouteName.ENROLLMENT,
          component: () => import('../views/pages/administrator/enroll.vue'),
          meta: { requiresAuth: true, keepAlive: true }
        },
        {
